...
const projetos_sem_id: ProjetoSemId[] = [
  {
    ...
    descricaoCompleta: "...",
    fotos: [`https://placehold.co/800x500/${get_project_color('SE')}/ffffff?text=Bancada+IoT`],
  ...
  },
  {
    ...
    descricaoCompleta: "...",
    fotos: [`https://placehold.co/800x500/${get_project_color('IM')}/ffffff?text=Interface+Mobile`],
    formLink: "https://forms.google.com",
    membrosIds: [
  ...
  },
  {
    ...
    descricaoCompleta: "...",
    fotos: [`https://placehold.co/800x500/${get_project_color('VC')}/ffffff?text=Visão+Computacional+e+IA"`],
    formLink: "https://forms.google.com",
    membrosIds: [
      "4df90e4fb61f5a08a6a8e8c8678e0a8e",
      "2e5c718c5e775e2784217806e9018a5a",
