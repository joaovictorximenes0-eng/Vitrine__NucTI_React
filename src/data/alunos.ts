...
export const alunos_sem_id: MembroEquipeSemId[] = [
  {
    ...
    categoria: "aluno",
    foto: `https://placehold.co/200x200/${get_student_color('AB')}/ffffff?text=AB`,
  ...
  },
  {
    ...
    categoria: "aluno",
    foto: `https://placehold.co/200x200/${get_student_color('CE')}/ffffff?text=CE`,
  ...
  },
  {
    ...
    categoria: "aluno",
    foto: `https://placehold.co/200x200/${get_student_color('GM')}/ffffff?text=GM`,
    redesSociais: { github: "https://github.com" },
  },
  {
    nome: "Mariana Costa",
    ...
    categoria: "aluno",
    foto: `https://placehold.co/200x200/${get_student_color('MC')}/ffffff?text=MC`,
